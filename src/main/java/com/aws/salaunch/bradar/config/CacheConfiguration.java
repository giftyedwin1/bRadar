package com.aws.salaunch.bradar.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.aws.salaunch.bradar.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.aws.salaunch.bradar.repository.UserRepository.USERS_BY_EMAIL_CACHE);
