...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AISLEDISCOUNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_AISLEDISCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AISLEDISCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AISLEDISCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AISLEDISCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AISLEDISCOUNT actions', async () => {
      const expectedActions = [
        {
